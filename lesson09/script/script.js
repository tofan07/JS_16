...
const calcBtn = document.getElementById('start'),
      ...
      addIncomeTitle = document.querySelectorAll('.additional_income-item'),
      resultValues = document.getElementsByClassName('result-total'),
      moneyAmount = document.querySelector('.salary-amount'),
      incomeTitle = document.querySelector('input.income-title'),
      incomeAmount = document.querySelector('.income-amount'),
      expensesTitle = document.querySelector('input.expenses-title'),
      expensesAmount = document.querySelector('input.expenses-amount'),
      addExpensesTitle = document.querySelector('.additional_expenses-item'),
